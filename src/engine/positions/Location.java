...
public class Location implements Printable {
	...
	/**
	 * Called once per turn, so that Locations can experience the passage time. If
	 * that's
	 * important to them.
	 */
	public void tick() {
	 ...
	 *
	 * @return a MoveActorAction that allows actor to move to location if allowed;
	 *         otherwise null
	 */
