...
public class Exit {
	 ...
	 * @param hotKey      key to use in the menu to represent the Action to go to
	 *                    this Location
	 */
	...
	/**
	 * The name of the exit. Might be a direction, or the name of the destination.
	 * e.g. "North", or "to Mars".
	 * 
	...
	/**
	 * The preferred hotkey to use for a MoveAction. Lets the game always use the
	 * same keys for movement, and makes marking so much easier.
	 * 
	 * @return the hotkey
	 */
