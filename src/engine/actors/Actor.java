...
/**
 * An entity that is alive by having hit points. It also holds inventory that
 * stores items.
 */
public abstract class Actor implements Capable, Printable {
	 ...
	 * 
	 * @param displayChar one character that will be displayed in the
	 *                    terminal/console
	 */
	...
	/**
	 * Increases maximum hit points and set current hit points to that new maximum
	 * hit points.
	 *
	...
	/**
	 * reset maximum hit points and set current hit points to that new max hit
	 * points.
	 * 
