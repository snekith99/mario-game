...
/**
 * A thin wrapper for <code>java.util.ArrayList&lt;Action&gt;</code> that does
 * not allow nulls to be added.
 *
 */
public class ActionList implements Iterable<Action> {
	...
	/**
	 * Appends a single Action to this collection, if it is non-null. If it is null,
	 * then it is ignored.
	 * 
	 ...
	 * 
	 * Implementing this method means that Actions implements the Iterable
	 ...
	 * 
	 * @param comparator an object that can compare two Actions and determine their
	 *                   ordering
	...
	/**
	 * Remove the first occurrence of an Action from the collection, if it is
	 * present. If it is not present, the list is unchanged.
	 * 
	 ...
	 * @return the <code>i</code>'th Action in the collection
	 * @throws IndexOutOfBoundsException when <code>i</code> &gt;=
	 *                                   <code>this.size()</code>
	 */
