...
public class Application {
	...
	public static void main(String[] args) {
		...
		FancyGroundFactory groundFactory = new FancyGroundFactory(new Dirt(), new Wall(), new Floor(), new Sapling(),
				new Sprout(), new Mature(), new Lava(), new WarpPipe(), new HealthFountain(), new PowerFountain());
